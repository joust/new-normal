...
class MessageBoxElement extends HTMLElement {
  ...
  build() {
      ...
      dialogElm.classList.add('msg-box-dialog')
      dialogHeaderElm.classList.add('msg-box-dialog-header')
      dialogBodyElm.classList.add('msg-box-dialog-body')
      dialogFooterElm.classList.add('msg-box-dialog-footer')
  ...
  disposeDialog() {
      const self = this
      const dialogElm = self.shadowRoot.querySelector('.msg-box-dialog')
  ...
  setPrompt(content, title) {
    ...
    const dialogBodyElm = self.shadowRoot.querySelector('.msg-box-dialog-body')
