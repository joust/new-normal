class Swipy {
  ...
  bind() {
    this.root.addEventListener('touchstart', (self => {
      return (e) => {
        self.handleTouchStart(e)
      }
    })(this), false)
    this.root.addEventListener('touchmove', (self => {
      return e => {
  ...
  unbind() {
    this.root.removeEventListener('touchstart', (self => {
      return e => {
        self.handleTouchStart(e)
      }
    })(this))
    this.root.removeEventListener('touchmove', (self => {
      return e => {
        self.handleTouchMove(e)
      }
    })(this))
